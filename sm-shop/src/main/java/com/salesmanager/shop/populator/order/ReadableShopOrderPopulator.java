...
public class ReadableShopOrderPopulator extends
	...
	public ReadableShopOrder populate(ShopOrder source,
		...
		try {
			...
			setBillingAdresse(customer, persistableCustomer);
			setDeliveryAdresse(customer, persistableCustomer);
...
/*			if(persistableCustomer.getAttributes()!=null) {
	...
	private void setDeliveryAdresse(ReadableCustomer customer, PersistableCustomer persistableCustomer) {
	...
	private void setBillingAdresse(ReadableCustomer customer, PersistableCustomer persistableCustomer) {
